...
Проблемалық аймақтардың (визуалды маркерлердің) координаталарын 0-ден 1000-ға дейінгі масштабта [ymin, xmin, ymax, xmax] форматында көрсетіңіз және оларға сипаттама беріңіз.
